        ...
        <aside style={sidebarStyle}>
            ...
            <div style={{ borderTop: '1px solid #eceef2', padding: '14px 12px' }}>
                <div style={{ alignItems: 'center', display: 'flex', flexDirection: 'column', gap: 8, padding: '8px 12px' }}>
                    <span style={{ alignItems: 'center', background: ACCENT, borderRadius: '50%', color: '#ffffff', display: 'flex', flex: 'none', fontFamily: FONT_HEADING, fontSize: 16, fontWeight: 600, height: 44, justifyContent: 'center', width: 44 }}>{userEmail.slice(0, 2).toUpperCase()}</span>
